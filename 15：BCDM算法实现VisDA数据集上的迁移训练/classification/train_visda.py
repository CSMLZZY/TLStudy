    ...
    for ep in range(num_epoch):
        ...
        for batch_idx, data in enumerate(dataset):
            ...
            if batch_idx % args.log_interval == 0:
                ...
                writer.add_scalars("train", {'cls_loss_C1': loss1.item(),
                                             'cls_loss2_C2': loss2.item(),
                                             'cdd_loss': loss_dis.item(),
                                             'entropy': entropy_loss.item()}, batch_idx)

        # test
        temp_acc = test(ep + 1, writer)
...
def test(epoch, writer):
    ...
    writer.add_scalar("test_acc", temp_acc, epoch)
