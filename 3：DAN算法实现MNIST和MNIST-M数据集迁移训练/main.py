...
# 使用TSNE将高维数据可视化(进行域适应前的数据)
src_features = common_net(Variable(src_imgs.expand(src_imgs.shape[0], 3, 28, 28).to(device)))
tgt_features = common_net(Variable(tgt_imgs.expand(tgt_imgs.shape[0], 3, 28, 28).to(device)))
