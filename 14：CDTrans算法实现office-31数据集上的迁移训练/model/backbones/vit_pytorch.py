    ...
    def load_param(self, model_path):
        ...
        for i in param_dict:
            ...
            try:
                ...
                print('===========================ERROR=========================')
                print('shape do not match in i :{}: param_dict{} vs self.state_dict(){}'.format(i, param_dict[i].shape,
                                                                                                self.state_dict()[
                                                                                                    i].shape))
    ...
    def forward_features(self, x):
        ...
        if self.training:
            ...
            if prob < self.prob:
                ...
                mask = torch.where(mask > self.thresh, torch.Tensor([1]).cuda(),
                                   torch.Tensor([0]).cuda())  # [64, 16, 8]
...
def vit_small_patch16_224_TransReID(img_size=(256, 128), stride_size=16, drop_path_rate=0.1, drop_rate=0.0,
